  ...
  return (
    ...
    >
      ...
      <nav className="flex-1 py-6 px-4 space-y-2 mt-5">
        <div
          className={`text-xs font-semibold ${darkMode ? "text-gray-500" : "text-gray-400"} mb-4 px-2 tracking-wider`}
        >
          MAIN NAVIGATION
        </div>
        ...
        >
          ...
          >
            <KanbanIcon className="text-sm" />
          </div>
          <span className="font-medium flex-1 text-left">Kanban Board</span>
        </button>
        ...
        <div
          className={`h-px ${darkMode ? "bg-gray-700" : "bg-gray-200"} my-6`}
        />
        ...
        {projects.slice(0, 4).map((project) => (
          ...
          >
            ...
            <span
              className={`text-xs ${darkMode ? "bg-gray-700 text-gray-300" : "bg-gray-200 text-gray-800"} px-2 py-0.5 rounded-md ml-2`}
            >
              {
                tasks.filter((t) => t.project === (project.name || project))
                  .length
              }
            </span>
          </button>
      ...
      {/* Bottom Actions */}
      <div
        className={`px-4 py-6 border-t ${darkMode ? "border-gray-700 bg-gray-800" : "border-gray-200 bg-white"} space-y-4`}
      >
        <button
          onClick={onAddTask}
